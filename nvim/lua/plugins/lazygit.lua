...
vim.keymap.set("n", "<space>tv", ":ToggleTerm size=15 direction=horizontal<cr>", { silent = true })
vim.keymap.set("n", "<space>th", ":ToggleTerm size=60 direction=vertical<cr>", { silent = true })
vim.keymap.set("n", "<leader>go", "<cmd>lua Lazygit_toggle()<CR>", { silent = true })
